...
public class AuctionPageNavigation {
	...
	public void setConNavigator() {
		...
		if (this.isNowFirst()) {
			tmpNavigator.append("  <td><font color='#999999'>\n<a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','1');\">");
			...
			tmpNavigator.append("   <img src='" + root + "/img/community/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록 </a>\n");
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','" + prePage + "','1');\">");
			tmpNavigator.append("   <img src='" + root + "/img/community/icon_prev01.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
		...
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				...
				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','" + i + "','1');\">" + i + "</td>\n");
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			}
		}
		...
		if (this.isNowEnd()) {
			...
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','" + nextPage + "','1');\">다음<img");
			tmpNavigator.append(" src='" + root + "/img/community/icon_next01.gif' width='3' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'></a>\n");
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','" + totalPageCount + "','1');\">끝목록<img src='" + root + "/img/board/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
		}
	...
	public void setEndNavigator() {
		...
		if (this.isNowFirst()) {
			...
			tmpNavigator.append("  <td>\n<a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','1');\">");
			tmpNavigator.append("   <img src='" + root + "/img/community/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록 </a>\n");
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','" + prePage + "');\">");
			tmpNavigator.append("   <img src='" + root + "/img/community/icon_prev01.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
			tmpNavigator.append("   이전</a>");
		}
		tmpNavigator.append("  \n</td>\n");
		...
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				...
				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','" + i + "');\">" + i + "</td>\n");
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			}
		}
		...
		if (this.isNowEnd()) {
			...
			int nextPage = (pageNo - 1) / pageSize * pageSize + pageSize + 1;//(pageNo + pageSize - 1) / pageSize * pageSize + 1
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','" + nextPage + "');\">다음<img");
			tmpNavigator.append(" src='" + root + "/img/community/icon_next01.gif' width='3' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'></a>\n");
			tmpNavigator.append("   <a href=\"javascript:categoryList('','','" + category1 + "','" + category2 + "','" + gudan + "','1','" + totalPageCount + "');\">끝목록<img src='" + root + "/img/board/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
		}

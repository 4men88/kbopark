...
Web.Editor.prototype = {
			...
			if (obj) {
				...
				if (tid) {
					...
					"<table border=0 cellspacing=2 cellpadding=0 class=alc-cntxt-box><tr><td><table border=0 cellspacing=0 cellpadding=2 class=alc-cntxt-bs>"+
						"<tr><td rowspan=5 class=alc-cntxt-main><img src="+Alice.config.imageroot+"alice/editor/table_row.gif></td><td rowspan=5 valign=top style=padding-top:4;width:70><b>�� �ɼ�</td><td onclick=\"Alice.table.appendRowBefore('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>���� �� �߰�</td></tr>"+
						"<tr><td onclick=\"Alice.table.appendRowAfter('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�Ʒ��� �� �߰�</td></tr>"+
						"<tr><td onclick=\"Alice.table.removeRow('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش��� ����</td></tr>"+
						"<tr><td onclick=\"Alice.color.togglePicker('"+d1+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش��� ���� <div style=position:absolute;left:300;width:200px;display:none id='"+d1+"' onclick=\"Alice.table.colorRow('"+alice+"','"+tid+"')\"></div></td></tr>"+
						"<tr><td class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش��� �������� <input type=text id=unc-tab-hei-conf title='�ش��� ��������' style='width:40;height:15px;font-size:10px;'> <span onclick=\"Alice.table.rapHeightCol('"+alice+"','"+tid+"')\" style='cursor:pointer'>�Է�</span></td></tr>"+
						"<tr><td colspan=4 height=1 bgcolor=#dddddd></td></tr>"+
						"<tr><td rowspan=5 class=alc-cntxt-main><img src="+Alice.config.imageroot+"alice/editor/table_col.gif></td><td rowspan=5 valign=top style=padding-top:4><b>�� �ɼ�</td><td onclick=\"Alice.table.appendColBefore('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>������ �� �߰�</td></tr>"+
						"<tr><td onclick=\"Alice.table.appendColAfter('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>������ �� �߰�</td></tr>"+
						"<tr><td onclick=\"Alice.table.removeCol('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش翭 ����</td></tr>"+
						"<tr><td onclick=\"Alice.color.togglePicker('"+d2+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش翭 ���� <div style=position:absolute;left:300;width:200px;display:none id='"+d2+"' onclick=\"Alice.table.colorCol('"+alice+"','"+tid+"')\"></div></td></tr>"+
						"<tr><td class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش翭 �ʺ����� <input type=text id=unc-tab-wid-conf title='�ش翭 �ʺ�����' style='width:40;height:15px;font-size:10px;'> <span onclick=\"Alice.table.rapWidthCol('"+alice+"','"+tid+"')\" style='cursor:pointer'>�Է�</span></td></tr>"+
						"<tr><td colspan=4 height=1 bgcolor=#dddddd></td></tr>"+
						"<tr><td rowspan=4 class=alc-cntxt-main><img src="+Alice.config.imageroot+"alice/editor/table_cell.gif></td><td rowspan=4 valign=top style=padding-top:4><b>�� �ɼ�</td><td onclick=\"Alice.table.mergeLeft('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�������� ��ġ��</td></tr>"+
						"<tr><td onclick=\"Alice.table.mergeRight('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�������� ��ġ��</td></tr>"+
						"<tr><td onclick=\"Alice.table.mergeDown('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�Ʒ��� ��ġ��</td></tr>"+
						"<tr><td onclick=\"Alice.color.togglePicker('"+d3+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>�ش缿 ���� <div style=position:absolute;left:250;width:200px;display:none id='"+d3+"' onclick=\"Alice.table.colorCell('"+alice+"','"+tid+"')\"></div></td></tr>"+
					"</table></td></tr></table>";
	...
	getContentWithLimit: function() {
		...
		if (this.isLimit()) {			
			Web.alert({title:'���', msg:'������ �ʹ� ���� �ۼ��ϼ̽��ϴ�<br>�ִ� ���� �ۼ����� ���ڼ��� <b>'+this.limit+'</b>����Ʈ �Դϴ�<br>���� �ۼ� ���ڼ��� <b>'+html.getByte()+'</b>����Ʈ �Դϴ�',width:400});
			return null;
		}
		return html;
	},
	...
	createHtml: function() {		
		...
		var fu = 		"<div id=alc-edit-property-"+seq+" class=alc-edit-fields>"+							
							"<span title='�ҽ�����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').toggleAlice();return false;\" enablebutton=on><img src="+image+"alice/editor/source.gif></button></span>"+
							"<span title='������ ���� �ʱ�ȭ'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').initContextWindow();return false;\"><img src="+image+"alice/editor/newpage.gif></button></span>"+
							"<span title='�̸�����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').previewContextWindow();return false;\"><img src="+image+"alice/editor/preview.gif></button></span>"+
					    	"<span title='����Ʈ'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').printContextWindow();return false;\"><img src="+image+"alice/editor/print.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
					    	"<span title='���� ����ϱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').command('Undo',-1);return false;\"><img src="+image+"alice/editor/undo.gif></button></span>"+
					    	"<span title='�ٽ� �����ϱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').command('Redo',1);return false;\"><img src="+image+"alice/editor/redo.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
					    	"<span title='�̹��� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupImage();return false;\"><img src="+image+"alice/editor/pic.gif></button></span>"+
					    	"<span title='�̹��� ��ũ ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupUrlImage();return false;\"><img src="+image+"alice/editor/urlpic.gif></button></span>"+
					    	"<span title='�÷��� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupFlash();return false;\"><img src="+image+"alice/editor/flash.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
					    	(this.aliceType == 'detail' || this.aliceType == 'normal' ? 
					    	"<span title='�ؽ�Ʈ ��ũ ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupCreateLink();return false;\"><img src="+image+"alice/editor/link.gif></button></span>"+
					    	"<span title='�ؽ�Ʈ ��ũ ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Unlink');return false;\"><img src="+image+"alice/editor/unlink.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"
					    	:"")+
					    	"<span title='ǥ ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupTable();return false;\"><img src="+image+"alice/editor/table.gif></button></span>"+
					    	"<span title='�ʵ�� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupField();return false;\"><img src="+image+"alice/editor/fieldset.gif></button></span>"+
					    	(this.aliceType == 'detail'? 
					    	"<span title='���� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').paste('Line');return false;\"><img src="+image+"alice/editor/line.gif></button></span>"+
					    	"<span title='������ �극��ũ ����(����Ʈ�� ���� �������� ����)'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').paste('Break');return false;\"><img src="+image+"alice/editor/pagebreak.gif></button></span>"
					    	:"")+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
					    	"<span title='������ ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('JustifyRight');return false;\"><img src="+image+"alice/editor/right.gif></button></span>"+
					    	"<span title='��� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('JustifyCenter');return false;\"><img src="+image+"alice/editor/center.gif></button></span>"+
					    	"<span title='���� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('JustifyLeft');return false;\"><img src="+image+"alice/editor/left.gif></button></span>"+
					    	"<span title='��ü ���߱�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('JustifyFull');return false;\"><img src="+image+"alice/editor/full.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
					    	(this.aliceType == 'detail' || this.aliceType == 'normal' ? 
					    		(this.aliceType == 'detail'?
					    	"<span title='�鿩���� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Outdent');return false;\"><img src="+image+"alice/editor/tableft.gif></button></span>"+
					    	"<span title='�鿩���� �ø�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Indent');return false;\"><img src="+image+"alice/editor/tabright.gif></button></span>"
					    		:"")+
					    	"<span title='��ȣ�ִ� ��� �ֱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('InsertOrderedList');return false;\"><img src="+image+"alice/editor/number.gif></button></span>"+
					    	"<span title='��ȣ���� ��� �ֱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('InsertUnorderedList');return false;\"><img src="+image+"alice/editor/point.gif></button></span>"+
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"
					    	:"")+
					    	"<span title='������ �ִ�������'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').extendContextWindow();return false;\"><img src="+image+"alice/editor/extend.gif></button></span>"+					    	
					    	"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
						"</div>"+
						"<div id=alc-text-property-"+seq+" class=alc-text-fields>"+
							"<span title='��Ÿ�� ����'>"+Web.util.Select.alice['alc-font-style'].gsub(/\{0\}/, seq).gsub(/\{1\}/, this.aliceId)+"</span>"+
							"<span title='��Ʈ ����'>"+Web.util.Select.alice['alc-font-family'].gsub(/\{0\}/, seq).gsub(/\{1\}/, this.aliceId)+"</span>"+
							"<span title='��Ʈũ�� ����'>"+Web.util.Select.alice['alc-font-size'].gsub(/\{0\}/, seq).gsub(/\{1\}/, this.aliceId)+"</span>"+
							"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
							"<span title='���� ���� �ֱ�'>"+Web.util.Select.alice['alc-font-bgcolor'].gsub(/\{0\}/, seq).gsub(/\{1\}/, this.aliceId).gsub(/\{2\}/, Alice.color.picker(this.seqId))+"</span>"+
							"<span title='���ڻ� �ֱ�'>"+Web.util.Select.alice['alc-font-forecolor'].gsub(/\{0\}/, seq).gsub(/\{1\}/, this.aliceId).gsub(/\{2\}/, Alice.color.picker(this.seqId))+"</span>"+
							"<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
						    "<span title='���� ����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Bold');return false;\"><img src="+image+"alice/editor/bold.gif></button></span>"+
						    (this.aliceType == 'detail' || this.aliceType == 'normal' ? 
						    "<span title='���� ����̱�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Italic');return false;\"><img src="+image+"alice/editor/italic.gif></button></span>"+
						    "<span title='���� ���ٳֱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Underline');return false;\"><img src="+image+"alice/editor/underline.gif></button></span>"+
						    "<span title='���� ���ǥ��'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Strikethrough');return false;\"><img src="+image+"alice/editor/strikethrough.gif></button></span>"
						    :"")+
						    "<span><img src="+image+"alice/editor/gray_separator.gif></span>"+
						    (this.aliceType == 'detail' || this.aliceType == 'normal' ? 
						    	(this.aliceType == 'detail'?
						    "<span title='�Ʒ� ÷��'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Subscript');return false;\"><img src="+image+"alice/editor/subscript.gif></button></span>"+
						    "<span title='�� ÷��'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('Superscript');return false;\"><img src="+image+"alice/editor/superscript.gif></button></span>"+
						    "<span><img src="+image+"alice/editor/gray_separator.gif></span>"
						    	:"")+
						    "<span title='���� �����'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('RemoveFormat');return false;\"><img src="+image+"alice/editor/removeformat.gif></button></span>"+						    
						    	(this.aliceType == 'detail'?
						    "<span title='������ �ֱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupIcon();return false;\"><img src="+image+"alice/editor/icon.gif></button></span>"+
						    "<span title='��ü �����ϱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').execute('SelectAll');return false;\"><img src="+image+"alice/editor/selectall.gif></button></span>"
						    	:"")+
						    "<span title='Ư������ �ֱ�'><button name=alc-bttns-"+seq+" onclick=\"Web.EditorManager.get('"+this.aliceId+"').popupSpecialChar();return false;\"><img src="+image+"alice/editor/specialchar.gif></button></span>"+
						    "<span><img src="+image+"alice/editor/gray_separator.gif></span>"
						    :"")+
					  	"</div>";
	...
	initContextWindow: function() {
		var cw = this.getAliceContentWindow();  
		var rg = this.range;
		Web.yesno({title:'������ �ʱ�ȭ',msg:'������ ������ �ʱ�ȭ �մϴ�', fnyes:function() {
	...
	popupImage: function() {
		...
		var txt = ""+
			...
			"<tr>"+
				"<td class=alc-pop-bs1><li>�̹���</li></td><td><input type=file name=alc-image-upload id=alc-image-upload style=width:325 onkeypress=this.blur()></td>"+
			"</tr>"+
			"<tr>"+
				"<td class=alc-pop-bs1><li>�̹��� ����</li></td><td><input type=text id=alc-image-alt style=width:325></td>"+
			"</tr>"+
			...
			"<tr>"+
				"<td colspan=2>"+
					"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>�ʺ�</li></td><td><input type=text id=alc-image-width title\"�ʺ�\" style=width:50 onkeyup=Alice.image.keyupWidth()></td>"+
						"<td align=center rowspan=7 class=alc-pop-bs0 valign=top><strong>�̸�����</strong><br><div style='padding:2px 2px 2px 2px;width:250px;height:130px;overflow:auto;border:1px solid #336699;background-color:#fff;font-size:8pt' id=alc-image-preview-text>"+
							"<img id=alc-image-preview style='filter:gray(enabled=false) xray(enabled=false) fliph(enabled=false) flipv(enabled=false) blur(enabled=false,add:1,direction:135) invert(enabled=false);display:none'>"+
								"���ع��� ��λ��� ������ �⵵�� �ϴ����� �����ϻ� �츮 ���� ���� �������� �� �ҳ��� ö���� �θ��� �ٶ����� �Һ����� �츮 ����ϼ� ���� �ϴ� ��Ȱ�ѵ� ���� ���� ���� ���� ���� �츮 ���� ���� �ܽ��ϼ� �� ���� �� ������ �漺�� ���Ͽ� ���ο쳪 ��ſ쳪 ���� ����ϼ�"+
							"</div></td>"+
					"</tr>"+     
					"<tr>"+      
						"<td class=alc-pop-bs1><li>����</li></td><td><input type=text id=alc-image-height title\"����\" style=width:50 onkeyup=Alice.image.keyupHeight()></td>"+
					"</tr>"+     
					"<tr>"+			   		
						"<td class=alc-pop-bs1><li>�׵θ�</li></td><td><input type=text id=alc-image-border title\"�׵θ�\" style=width:50 onkeyup=Alice.image.keyupBorder()></td>"+
					"</tr>"+     
					"<tr>"+      
						"<td class=alc-pop-bs1><li>���򿩹�</li></td><td><input type=text id=alc-image-hspace title\"���򿩹�\" style=width:50 onkeyup=Alice.image.keyupHspace()></td>"+
					"</tr>"+     
					"<tr>"+      
						"<td class=alc-pop-bs1><li>��������</li></td><td><input type=text id=alc-image-vspace title\"��������\" style=width:50 onkeyup=Alice.image.keyupVspace()></td>"+
					"</tr>"+     
					"<tr>"+      
						"<td class=alc-pop-bs1><li>����</li></td><td>"+
							"<select id=alc-image-order onchange=Alice.image.changeOrder()>"+
								...
								"<option value=absmiddle>���߰�</option>"+
								"<option value=absbottom>�پƷ�</option>"+
					...
					"</tr>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>�۰��и�</li></td><td><input type=checkbox id=alc-image-break onclick=Alice.image.insertBreak()></td>"+
					"</tr>"+
					(Web.isIE? 
					"<tr>"+
						"<td colspan=3>"+
							"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+								
								"<tr>"+
									"<td class=alc-pop-bs1><li>�����ȯ</li></td><td valign=top><input type=checkbox id=alc-image-black onclick=Alice.image.transformGray()></td>"+
									"<td class=alc-pop-bs1><li>��������</li></td><td valign=top><input type=checkbox id=alc-image-xray onclick=Alice.image.transformXray()></td>"+
									"<td class=alc-pop-bs1><li>����ݴ�</li></td><td valign=top><input type=checkbox id=alc-image-invert onclick=Alice.image.transformInvert()></td>"+
								"</tr>"+
								"<tr>"+
								"<td class=alc-pop-bs1><li>�ε巴��</li></td><td valign=top><input type=checkbox id=alc-image-blur onclick=Alice.image.transformBlur()></td>"+
									"<td class=alc-pop-bs1><li>�¿캯��</li></td><td valign=top><input type=checkbox id=alc-image-fliph onclick=Alice.image.transformFliph()></td>"+
									"<td class=alc-pop-bs1><li>���Ϻ���</li></td><td valign=top><input type=checkbox id=alc-image-flipv onclick=Alice.image.transformFlipv()></td>"+
								"</tr>"+
							"</table>"+
						"</td>"+
					"</tr>":"")+
		...
		Web.popup({title:'�̹��� ����',msg:txt,width:500,height:440});
	...
	popupFlash: function() {
		...
		var txt = ""+						
			...
			"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+
			"<tr>"+
				"<td class=alc-pop-bs1><li>�÷���</li></td><td><input type=file name=alc-flash-upload id=alc-flash-upload style=width:320 onkeypress=this.blur()></td>"+
			"</tr>"+
					...
					"<tr>"+
						"<td valign=top width=180><br>"+
							"<table border=0 cellspacing=0 cellpadding=0>"+
								"<tr>"+
									"<td valign=top class=alc-pop-bs1><li>�ʺ�</li></td><td valign=top><input type=text id=alc-flash-width style=width:70 onkeyup=Alice.flash.keyupWidth()></td>"+
								"</tr>"+
								"<tr>"+
									"<td valign=top class=alc-pop-bs1><li>����</li></td><td valign=top><input type=text id=alc-flash-height style=width:70 onkeyup=Alice.flash.keyupHeight()></td>"+						
								"</tr>"+
							"</table>"+
						"</td>"+
						"<td align=center class=alc-pop-bs0 valign=top>"+
							"<strong>�̸�����</strong><br><div style='padding:2px 2px 2px 2px;width:230px;height:130px;overflow:auto;border:1px solid #336699;background-color:#fff' id=alc-flash-preview></div></td>"+
					"</table>"+
				"</td>"+
			"</tr>"+			
			"</table>"+
		...
		Web.popup({title:'�÷��� ����',msg:txt,width:500,height:350});
		Web.Form.setStyle("aliceForm");
	},
	...
	popupTable: function() {
		...
		var txt = ""+			
			...
			"<table border=0 width=100% cellspacing=0 cellpadding=0 class=alc-pop-bs0>"+				
				"<tr height=25>"+
					"<td width=25%><li>������</li></td>"+
					"<td width=25%><Input type=text id=trow size=4 value=5></td>"+
					"<td width=25%><li>�ʺ�</li></td>"+
					"<td width=25%><input type=text id=twidth size=4 value=400> <select id=tsize><option value=picxel>�ȼ�</option><option value=percentage>�ۼ�Ʈ</option></select></td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>������</li></td>"+
					"<td><input type=text id=tcol size=4 value=3></td>"+
					"<td><li>����</li></td>"+
					"<td><input type=text id=theight size=4 value=100> �ȼ�</td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>�׵θ� ũ��</li></td>"+
		...
		Web.popup({title:'���̺� ����',msg:txt,width:570,height:400});
		Web.Form.setStyle("aliceForm");
	},
	...
	popupField: function() {
		...
		var txt = ""+			
			...
			"<table border=0 width=100% cellspacing=0 cellpadding=0 class=alc-pop-bs0>"+				
				"<tr height=25>"+
					"<td width=25%><li>�ʺ�</li></td>"+
					"<td width=25%><input type=text id=fwidth size=4 value=100> <select id=fsize><option value=picxel>�ȼ�</option><option value=percentage selected>�ۼ�Ʈ</option></select></td>"+
					"<td width=25%><li>����</li></td>"+
					"<td width=25%><input type=text id=fheight size=4>�ȼ�</td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>����</li></td>"+
					"<td><select id=falign>"+
				...
				"<tr height=25>"+
					...
					"<td><li>���ʿ���</li></td>"+
					"<td><input type=text id=fptop size=4 value=5> �ȼ�</td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>�����ʿ���</li></td>"+
				...
				"<tr height=25>"+
					...
					"<td><li>�׵θ���Ÿ��</li></td>"+
					"<td><input type=radio name=fborderstyle value=solid checked>�� <input type=radio name=fborderstyle value=dotted>���� <input type=radio name=fborderstyle value='none'>����</td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>����</li></td>"+
				...
				"<tr>"+
					...
					"<td colspan=3>"+
						"<table border=0 cellspacing=0 cellpadding=0 style=font-size:9pt>"+
						    "<tr>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','solid','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;'><center><br>�ʵ��</center></fieldset></td>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','none','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;border:none'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','dotted','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;border:1px dotted #999999'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#CAE5FF','solid','#90C8FF')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#CAE5FF;width:50;height:40;margin :0;padding:0;border:1px solid #90C8FF'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#CAE5FF','dotted','#90C8FF')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#CAE5FF;width:50;height:40;margin :0;padding:0;border:1px dotted #90C8FF'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#ffffee','solid','#999999','#660066')\" onmouseover=this.style.color='red' onmouseout=this.style.color='#660066' style='cursor:pointer;background-color:#ffffee;width:50;height:40;margin :0;padding:0;color:#660066'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#ffffee','dotted','#999999','#660066')\" onmouseover=this.style.color='red' onmouseout=this.style.color='#660066' style='cursor:pointer;background-color:#ffffee;width:50;height:40;margin :0;padding:0;color:#660066;border:1px dotted #999999'><center><br>�ʵ��</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#ffffee','none','#999999','#660066')\" onmouseover=this.style.color='red' onmouseout=this.style.color='#660066' style='cursor:pointer;background-color:#ffffee;width:50;height:40;margin :0;padding:0;color:#660066;border:none'><center><br>�ʵ��</center></fieldset>"+
							"</tr>"+
						"</table>"+
					"</td>"+
				"</tr>"+				
		...
		Web.popup({title:'�ʵ�� ����',msg:txt,width:600,height:340});
		Web.Form.setStyle("aliceForm");
	},
	...
	popupUrlImage: function() {
		...
		var txt = ""+			
			...
			"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+			
			"<tr>"+
				"<td class=alc-pop-bs1><li>�̹���</li></td><td><input type=text id=alc-urlimage-link style=width:325></td>"+
			"</tr>"+
			"<tr>"+
				"<td class=alc-pop-bs1><li>�̹��� ����</li></td><td><input type=text id=alc-urlimage-alt style=width:325></td>"+
			"</tr>"+
			...
			"<tr>"+
				"<td colspan=2>"+
					"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>�ʺ�</li></td><td><input type=text id=alc-urlimage-width title=\"�ʺ�\" style=width:50 onkeyup=Alice.urlimage.keyupWidth()></td>"+
						"<td align=center rowspan=6 class=alc-pop-bs0 valign=top><strong>�̸�����</strong><br><div style='padding:2px 2px 2px 2px;width:250px;height:130px;overflow:auto;border:1px solid #336699;background-color:#fff' id=alc-urlimage-preview-text>"+
							"<img id=alc-urlimage-preview style=display:none>"+
								"������ ������ ���� ���Ŵ� ����, �߰, û������ ���� ����, ��ܹ�, â�� �����صΰ� ���� 5������ �ֱٱ��� ��ǰ�� �Ȱ��� ���� ���� 9õ145��(��ǰ�� 110���)�� ���� �� �ش� ��ǥ�� �ٿ� ���빮�� ���빮 ���� ���ҸŻ�鿡�� �Ǹ��� ���Ǹ� �ް� �ִ�. ���� ��� ���ӵ� ������ �ֿ� ��ǰȸ����� ������Ʈ 1������ �÷����� �ѱ� �ְ��� ¦�� ����ڷμ� �ٸ� ¦�� ���ڵ��� ������ ����ϴ� �� ���ϱ� ���� ģ���� �������� ���� ��ܹ�� ������ å���ڷ� ����� ������ �巯����."+
							"</div></td>"+
					"</tr>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>����</li></td><td><input type=text id=alc-urlimage-height title\"����\" style=width:50 onkeyup=Alice.urlimage.keyupHeight()></td>"+
					"</tr>"+
					"<tr>"+					
						"<td class=alc-pop-bs1><li>�׵θ�</li></td><td><input type=text id=alc-urlimage-border title\"�׵θ�\" style=width:50 onkeyup=Alice.urlimage.keyupBorder()></td>"+
					"</tr>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>���򿩹�</li></td><td><input type=text id=alc-urlimage-hspace title\"���򿩹�\" style=width:50 onkeyup=Alice.urlimage.keyupHspace()></td>"+
					"</tr>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>��������</li></td><td><input type=text id=alc-urlimage-vspace title\"��������\" style=width:50 onkeyup=Alice.urlimage.keyupVspace()></td>"+
					"</tr>"+
					"<tr>"+
						"<td class=alc-pop-bs1><li>����</li></td><td>"+
			...
			"</tr>"+
			"<tr>"+
				"<td class=alc-pop-bs1><li>�۰��и�</li></td><td><input type=checkbox id=alc-urlimage-break onclick=Alice.urlimage.insertBreak()></td>"+
			"</tr>"+			
			"</table>"+
			"</form>"+
		...
		Web.popup({title:'�̹��� ��ũ ����',msg:txt,width:500,height:380});
		Web.Form.setStyle("aliceForm");
	},
	...
	popupIcon: function() {
		...
		Web.popup({title:'������ ����',msg:txt,width:250,height:280});
	},
	...
	popupSpecialChar: function() {
		...
		Web.popup({title:'Ư������ ����',msg:txt,width:460,height:600});
	},
	...
	popupCreateLink: function() {
		...
		var txt = ""+			
			...
			"<table border=0 cellspacing=0 cellpadding=0 width=100%>"+			
			"<tr>"+
				"<td class=alc-pop-bs1><li>��ũ</li></td><td><input type=text id=alc-link-url style=width:325></td>"+
			"</tr>"+
			"<tr>"+
				"<td class=alc-pop-bs1><li>�ؽ�Ʈ</li></td><td><input type=text id=alc-link-text style=width:325></td>"+
			"</tr>"+			
			"</table>"+
			"</form>"+
		...
		Web.popup({title:'�ؽ�Ʈ ��ũ ����',msg:txt,width:500,height:150});
		Web.Form.setStyle("aliceForm");
	}
};
...
Alice.image = {
	...
	upload: function() {
		...
		if (!Web.Form.validateFile("alc-image-upload", "gif", "jpg", "png", "jpeg")) {
			Web.alert({title:'���',msg:'GIF,JPG,PNG,JPEG ���ϸ� ���ΰ� �����մϴ�'});
			return;	
		}
...
Alice.urlimage = {
	change: function() {
		if ($("alc-urlimage-link").present()) {
			...
			Web.alert({title:'���',msg:'�̹��� �ּҸ� �Է��ϼ���',focus:"alc-urlimage-link"});
		}
	},
	keyupWidth: function() {
	...
	apply: function(id) {
		if ($("alc-is-createlink").value != "Y") {
			Web.alert({title:'���',msg:'�̹��� �ּҸ� �Է� �� ���ε� ��ư�� Ŭ���ϼ���',focus:"alc-urlimage-link"});
			return;	
		}
...
Alice.link = {
	apply: function(id) {
		if (!$("alc-link-url").present() || !$("alc-link-text").present()) {
			Web.alert({title:'���',msg:'��ũ�� ���� �ּҿ� �ؽ�Ʈ�� �Է��ϼ���',focus:"alc-link-url"});
			return;	
		}
...
Object.extend(Web.util.Image, {
	alice: {
		'alc-crud-upload':'<span title="���ε�" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_upload.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_upload_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_upload.gif"></span>',
		'alc-crud-apply':'<span title="�����ϱ�" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_apply.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_apply_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_apply.gif"></span>',
		'alc-crud-cancel':'<span title="���" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_cancel.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_cancel_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_cancel.gif"></span>',
		'alc-crud-select':'<span title="�����ϱ�" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_check.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_check_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_check.gif"></span>',
		'alc-crud-loading':'<span title="�ε���" class=alc-crud><img src='+Alice.config.imageroot+'alice/form/i_loading.gif></span>',
		'alc-etc-up':'<span title="����" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_up.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_up_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_up.gif"></span>',
		'alc-etc-down':'<span title="����" class=alc-crud><img src='+Alice.config.imageroot+'alice/button/btn_down.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/button/btn_down_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/button/btn_down.gif"></span>'
	}
});
	...
	alice: {
		...
		'alc-font-family':'<div><button name=alc-select-{0} style="width:98px" onclick="Web.EditorManager.get(\'{1}\').popupFontFamily();return false;"><img src='+Alice.config.imageroot+'alice/form/sel_font.gif onmouseover=this.src="'+Alice.config.imageroot+'alice/form/sel_font_o.gif" onmouseout=this.src="'+Alice.config.imageroot+'alice/form/sel_font.gif" class=alc-img-b></button></div>'+
			'<div id=alc-font-family-box-{0} class=alc-font-box>'+
				...
				'<div class=alc-select-font-style onmouseover=this.className="alc-select-font-style-o" onmouseout=this.className="alc-select-font-style" onclick="Alice.font.setFamily(\'{1}\',\'�ü�\')" style="font-family:�ü�">�ü�</div>'+
				'<div class=alc-select-font-style onmouseover=this.className="alc-select-font-style-o" onmouseout=this.className="alc-select-font-style" onclick="Alice.font.setFamily(\'{1}\',\'����\')" style="font-family:����">����</div>'+
				'<div class=alc-select-font-style onmouseover=this.className="alc-select-font-style-o" onmouseout=this.className="alc-select-font-style" onclick="Alice.font.setFamily(\'{1}\',\'����\')" style="font-family:����">����</div>'+
